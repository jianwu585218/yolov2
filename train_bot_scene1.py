...
def get_args():
	...
	# parser.add_argument("--pre_trained_model_path", type=str, default="trained_bot_models/scene1/only_params_trained_yolo_bot")
	...
	parser.add_argument("--log_path", type=str, default="tensorboard/yolo_bot_person3/scene1")
	parser.add_argument("--saved_path", type=str, default="trained_bot_person_models3/scene1")
...
def train(opt):
	...
	training_set = BOTDataset_scene(opt.data_path, opt.train_set, opt.image_size, scene = 1)

	training_generator = DataLoader(training_set, **training_params)

	test_set = BOTDataset_scene(opt.data_path, opt.test_set, opt.image_size, scene = 1, is_training=False)
