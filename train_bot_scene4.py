...
from src.voc_dataset import BOTDataset_scene
...
def get_args():
	...
	# parser.add_argument("--pre_trained_model_path", type=str, default="trained_bot_models/scene4/only_params_trained_yolo_bot")
	parser.add_argument("--pre_trained_model_path", type=str, default="trained_coco14_17_models/only_params_trained_yolo_coco")
	parser.add_argument("--log_path", type=str, default="tensorboard/yolo_bot_person3/scene4")
	parser.add_argument("--saved_path", type=str, default="trained_bot_person_models3/scene4")
...
def train(opt):
	...
	training_set = BOTDataset_scene(opt.data_path, opt.train_set, opt.image_size, scene = 4)
	# mmm = training_set[0]
	# print(1)
	training_generator = DataLoader(training_set, **training_params)

	test_set = BOTDataset_scene(opt.data_path, opt.test_set, opt.image_size, scene = 4, is_training=False)
